...
/**
 ...
 return this;
  ...
  async build() {
    ...
    if(this.spotifyLogo){
    try {
      ctx.drawImage(await loadImage(`https://cdn.glitch.global/c5307e2b-658c-4627-9887-a0e6eb1aadba/2fa2cf54-21cc-42a7-8ee3-0fdc960bdf8e.image.png?v=1712251134963`), 950, 60, 100, 100);
    } catch {
